...
* Go to the Input_files folder and edit the instructions.txt file with the name of the karstic network and the path to the main repository (root repository = KarstNSim_Public).
